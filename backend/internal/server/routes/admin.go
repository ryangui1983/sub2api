...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/purge-deleted", h.Admin.Account.PurgeDeleted)
		accounts.POST("/purge-logs", h.Admin.Account.PurgeLogs)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/keyword-temp-unsched", h.Admin.Setting.GetKeywordTempUnschedSettings)
		adminSettings.PUT("/keyword-temp-unsched", h.Admin.Setting.UpdateKeywordTempUnschedSettings)
		// 429默认回避配置
		adminSettings.GET("/rate-limit-429-cooldown", h.Admin.Setting.GetRateLimit429CooldownSettings)
		adminSettings.PUT("/rate-limit-429-cooldown", h.Admin.Setting.UpdateRateLimit429CooldownSettings)
		// 促消耗调度配置
		adminSettings.GET("/burn-promote", h.Admin.Setting.GetBurnPromoteSettings)
		adminSettings.PUT("/burn-promote", h.Admin.Setting.UpdateBurnPromoteSettings)
